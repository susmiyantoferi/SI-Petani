                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="id" class="form-control" value="{{ $users->id  }}" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type = "date" name="created_at" class="form-control" value="{{ $users->created_at }}">
                                        <div class="text-danger">
                                            @error('created_at')
                                                {{ $message }}
                                            @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type = "date" name="updated_at" class="form-control" value="{{ $users->updated_at}}">
                                        <div class="text-danger">
                                            @error('updated_at')
                                                {{ $message }}
                                            @enderror
